 ...
 *
 */
public class BNDemoGuide2Activity extends Activity {

	private final String TAG = BNDemoGuide2Activity.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ReservationActivity.activityList.add(this);
		createHandler();
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(ReservationActivity.ROUTE_PLAN_NODE);
			}
		}
		//显示自定义图标
		if (hd != null) {
	...
	protected void onDestroy() {
		...
		ReservationActivity.activityList.remove(this);
