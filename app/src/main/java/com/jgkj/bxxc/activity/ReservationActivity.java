...
//	private Button mBdmcNaviBtn = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBDLocationListener = new ReservationActivity.MyBDLocationListener();
        // 注册监听
...
//    }
    ...
    public void showToastMsg(final String msg) {
        ReservationActivity.this.runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Toast.makeText(ReservationActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initNavi() {
        ...
        BaiduNaviManager.getInstance().init(this, mSDCardPath, APP_FOLDER_NAME, new BaiduNaviManager.NaviInitListener() {
                ...
                ReservationActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if(!"key校验成功!".equals(authinfo)){
                            Toast.makeText(ReservationActivity.this, authinfo, Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
            ...
            public void initFailed() {
                Toast.makeText(ReservationActivity.this, "百度导航引擎初始化失败", Toast.LENGTH_SHORT).show();
            }
    ...
    private void routeplanToNavi(BNRoutePlanNode.CoordinateType coType) {
        ...
        if (!hasInitSuccess) {
            Toast.makeText(ReservationActivity.this, "还未初始化!", Toast.LENGTH_SHORT).show();
        }
        // 权限申请
        if (android.os.Build.VERSION.SDK_INT >= 23) {
            // 保证导航功能完备
            if (!hasCompletePhoneAuth()) {
                if (!hasRequestComAuth) {
                    ...
                    Toast.makeText(ReservationActivity.this, "没有完备的权限!", Toast.LENGTH_SHORT).show();
                }
            }
...
//            }
        ...
        if (sNode != null && eNode != null) {
            ...
            list.add(sNode);
            list.add(eNode);
            BaiduNaviManager.getInstance().launchNavigator(this, list, 1, true, new ReservationActivity.DemoRoutePlanListener(sNode));
        }
    }
    ...
    public class DemoRoutePlanListener implements BaiduNaviManager.RoutePlanListener {
        ...
        public void onJumpToNavigator() {
            ...
            Intent intent = new Intent(ReservationActivity.this, BNDemoGuide2Activity.class);
        ...
        public void onRoutePlanFailed() {
            // TODO Auto-generated method stub
            Toast.makeText(ReservationActivity.this, "算路失败", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (requestCode == authBaseRequestCode) {
            for (int ret : grantResults) {
                if (ret == 0) {
                    ...
                    Toast.makeText(ReservationActivity.this, "缺少导航基本的权限!", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            initNavi();
