        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int i) {
                        Toast.makeText(ExtClassActivity.this, "网络状态不佳，请检查网络", Toast.LENGTH_LONG).show();
                    }
                    @Override
    ...
    private void sort(String class_type, String school, String sort, String page, String class_class) {
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    @Override
                    public void onError(Call call, Exception e, int i) {
                        Toast.makeText(ExtClassActivity.this, "请检查网络", Toast.LENGTH_LONG).show();
                    }
                    @Override
                    public void onResponse(String s, int i) {
                        listView.setTag(s);
        ...
        switch (swiTag) {
            ...
            case "ONLOAD":
                if (coachDetailAction.getCode() == 200) {
                    ...
                    Toast.makeText(ExtClassActivity.this, coachDetailAction.getReason(), Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
