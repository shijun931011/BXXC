...
import com.jgkj.bxxc.activity.PayInfoActivity;
...
public class CouAdapter extends BaseAdapter {
    private Context context;
    private List<Coupon.Result> list;
    private LayoutInflater inflater;
    private Coupon.Result result;
    private String uid;
    private PayInfoActivity.UseCoupon useCoupon;

    public CouAdapter(String uid, Context context, List<Coupon.Result> list, PayInfoActivity.UseCoupon useCoupon){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        CouponAdapter.ViewHolder viewHolder = null;
        if (convertView == null){
            viewHolder = new CouponAdapter.ViewHolder();
            convertView = inflater.inflate(R.layout.coupon, parent, false);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                useCoupon.dismissDialog();
                useCoupon.showPrice(list.get(position).getInvitefee());
            }
        });
